...
extension ProductDetailController :UITableViewDelegate,UITableViewDataSource{
    ...
    @IBAction func gotoMessengerApp(sender: UIButton){
        ...
        if let user_Id = user_data["user_id"] as? String{
            vc?.recipientID = user_Id
        }
        var last_messagedata = [String:Any]()
        if let last_data = user_data["last_message"] as? [String:Any]{
        ...
        let userData = GetUserListModel.User(userID: user_data["user_id"] as? String, username: user_data["username"] as? String, name: user_data["username"] as? String, avatar: user_data["avatar"] as? String, coverPicture: user_data["cover"] as? String, verified: user_data["verified"] as? String, lastseen: user_data["lastseen"] as? String, lastseenUnixTime: user_data["lastseen_unix_time"] as? String, lastseenTimeText: user_data["lastseen_unix_time"] as? String, url: user_data["url"] as? String, chatColor: user_data["chat_color"] as? String, chatTime: user_data["chat_time"] as? String, lastMessage: Last_message)
