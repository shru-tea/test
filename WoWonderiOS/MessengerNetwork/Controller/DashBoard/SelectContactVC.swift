...
//      var interstitial: GADInterstitial!
    ...
    func setupUI(){
        ...
        log.verbose("AppInstance.instance.sessionId = \(UserData.getAccess_Token() ?? "")")
...
//      }
    private func fetchData(){
        ...
        Async.background({
            SelectContactManger.instance.getContactList(user_id: AppInstance.instance.userId ?? "", session_Token: UserData.getAccess_Token() ?? "",  list_type: "all") { (success, sessionError, serverError, error) in
                if success != nil{
                    Async.main({
